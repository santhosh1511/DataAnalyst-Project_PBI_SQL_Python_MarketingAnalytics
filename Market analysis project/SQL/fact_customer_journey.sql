...
SELECT 
	...
	FORMAT(CONVERT(DATE, VisitDate), 'dd.MM.yyyy') AS VisitDate,  -- Converts and formats the date as dd.mm.yyyy and
	-- Selects the date of the visit to understand the timeline of customer interactions
